...
function stampGeometryFreeze(){document.documentElement.dataset.geometryBaseline='offset5-photo-v10';const status=$('#geometry-safety-status');if(status)status.textContent='PU1 GRIPPER SYSTEM · V10';}
