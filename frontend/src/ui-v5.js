...
function stampGeometryFreeze(){document.documentElement.dataset.geometryBaseline='offset5-photo-pdf-v13';const status=$('#geometry-safety-status');if(status)status.textContent='FEEDER + PU1 · PHOTO / OEM PDF V13';}
