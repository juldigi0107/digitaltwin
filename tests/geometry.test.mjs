...
test('photo-aligned geometry preserves orientation and bounded machine envelope',()=>{
 ...
 assert.equal(t.root.userData.version,'offset5-photo-v7');
 ...
 assert.ok(t.meshes.length<340,'mobile mesh budget exceeded');
 ...
 assert.equal(t.findNode('press-1-cylinder-train'),null,'PU2 internals must remain unchanged');
